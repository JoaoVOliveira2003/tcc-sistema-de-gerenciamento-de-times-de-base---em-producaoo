...
CREATE TABLE `role_cadastro` (
  `id_role_cadastro` INT NOT NULL AUTO_INCREMENT, 
  `cod_usuario` INT NOT NULL, 
  `cod_tipoRole` INT NOT NULL, 
  PRIMARY KEY (`id_role_cadastro`), 
...
CREATE TABLE `staff` (
  ...
  `ativo` CHAR(1), 
  `id_role_cadastro` INT NOT NULL, 
  PRIMARY KEY (`cod_staff`), 
  CONSTRAINT `fk_staff_role_cadastro` FOREIGN KEY (`id_role_cadastro`) REFERENCES `role_cadastro` (`id_role_cadastro`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
...
CREATE TABLE `administrador` (
  ...
  CONSTRAINT `fk_admin_role` FOREIGN KEY (`id_role_cadastro`) REFERENCES `role_cadastro` (`id_role_cadastro`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB;
...
CREATE TABLE `tcc`.`jogador` (
  ...
  FOREIGN KEY (`cod_jogador`) REFERENCES `role_cadastro`(`id_role_cadastro`), 
