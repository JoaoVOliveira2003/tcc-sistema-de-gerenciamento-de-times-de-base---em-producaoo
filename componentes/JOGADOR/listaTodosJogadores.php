...
if ($cod_role == 1) {
    ...
    $turmas = $bd->SqlExecuteQuery($queryTurmas) ? $bd->SqlQueryShow('turmas') : null;
...
// Execução da consulta e formatação da resposta
