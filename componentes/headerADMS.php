...
if ($executou && $bd->SqlNumRows() > 0) {
    ...
    do {
        ...
        // Se mudou de menu principal, inicia um novo dropdown
        if ($menu_principal != $ultimoMenu) {
            // Fecha o dropdown anterior, se houver
            if ($ultimoMenu !== null) {
                $retorno .= '</ul></li>'; // Fecha submenu e dropdown
            }
