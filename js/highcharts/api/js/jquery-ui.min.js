      ...
      e.widget("ui.resizable", e.ui.mouse, {
         ...
         _respectSize: function (e) {
            var t = this._vBoundaries,
               i = this.axis,
               s =
                  this._isNumber(e.width) && t.maxWidth && t.maxWidth < e.width,
               n =
                  this._isNumber(e.height) &&
                  t.maxHeight &&
                  t.maxHeight < e.height,
               a =
                  this._isNumber(e.width) && t.minWidth && t.minWidth > e.width,
               o =
                  this._isNumber(e.height) &&
                  t.minHeight &&
      ...
      _autoSize: function (e) {
         if (this._get(e, "autoSize") && !e.inline) {
            ...
            o.match(/[DM]/) &&
               ...
               a.setDate(
                  t(
                     this._get(e, o.match(/DD/) ? "dayNames" : "dayNamesShort")
                  ) +
                     20 -
                     a.getDay()
               )),
                      ...
                      (this._clickOffset = l
                         ...
                         : {
                              ...
                              top:
                                 ...
                                 (parseInt(a.css("borderBottomWidth"), 10) ||
                                    0) +
