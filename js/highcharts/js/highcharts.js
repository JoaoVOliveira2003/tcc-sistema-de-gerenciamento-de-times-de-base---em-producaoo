...
(function (C, Z) {
   ...
   var z,
      ...
      ca =
         A && A.createElementNS && !!A.createElementNS(Ga, "svg").createSVGRect,
   ...
   Wa = function (a, b, c) {
      ...
      X(c) ||
         ((d = arguments),
         (c = { duration: d[2], easing: d[3], complete: d[4] }));
   ...
   if (C.jQuery)
      C.jQuery.fn.highcharts = function () {
         ...
         if (this[0])
            return a[0]
               ? (new w[xa(a[0]) ? a.shift() : "Chart"](this[0], a[0], a[1]),
                 this)
   ...
   P.prototype = {
         ...
         if (f) {
            ...
            i[v]
               ...
               : ((g.id = n = "highcharts-" + zb++),
                 (i[v] = k = d.createElement(f).attr(g).add(d.defs)),
                 (k.radAttr = h),
                 (k.stops = []),
                 o(j, function (a) {
                    a[1].indexOf("rgba") === 0
            ...
            if (h.namespaceURI === Ga || d.forExport) {
               try {
                  (l =
                     ...
                     function (a) {
                        o(
                           h.querySelectorAll(".highcharts-text-shadow"),
                           function (b) {
                              b.style.display = a;
                           }
                        );
      ...
      titleSetter: function (a) {
         ...
         b ||
            ((b = A.createElementNS(Ga, "title")), this.element.appendChild(b));
         b.appendChild(
            A.createTextNode(String(p(a), "").replace(/<[^>]*>/g, ""))
         );
      },
   ...
   Ca.prototype = {
      ...
      init: function (a, b, c, d, e, f) {
         ...
         this.createElement("desc")
            .add()
            .element.appendChild(
               A.createTextNode("Created with Highcharts 4.2.4")
            );
      ...
      button: function (a, b, c, d, e, f, g, h, i) {
         ...
         N(k.element, ya ? "mouseout" : "mouseleave", function () {
            j !== 3 &&
               ((l = [e, f, g][j]), (m = [n, q, v][j]), k.attr(l).css(m));
         });
            ...
            if (A) {
               if (!m)
                  (a = ob),
                     ...
                     m.add(j);
               m.isImg ||
                  m.attr(s({ width: B(j.width), height: B(j.height) }, Y));
               Y = null;
            }
         };
         E = function () {
   ...
   if (!ca && !ia) {
      M = {
         init: function (a, b) {
            ...
            if (b)
               (c =
                  e || b === "span" || b === "img" ? c.join("") : a.prepVML(c)),
                  (this.element = $(c));
            this.renderer = a;
         },
         add: function (a) {
      ...
      M.prototype.ySetter =
         M.prototype.widthSetter =
         M.prototype.heightSetter =
            M.prototype.xSetter;
      var Bb = {
         Element: M,
      ...
      renderLabel: function (a, b, c, d) {
         ...
         if (!e)
            (e = { align: a.textAlign || a.align, rotation: a.rotation }),
               (e.zIndex = d),
               (this.label = e =
                  f.text(a.text, 0, 0, a.useHTML).attr(e).css(a.style).add());
         d = [b[1], b[4], c ? b[6] : b[1]];
         b = [b[2], b[5], c ? b[7] : b[2]];
         c = Qa(d);
         f = Qa(b);
   ...
   fa.prototype = {
      ...
      adjustForMinRange: function () {
         ...
         if (c - b < this.minRange) {
            ...
            c = Qa(c);
            c - b < j &&
               ((d[0] = c - j), (d[1] = p(a.min, c - j)), (b = Fa(d)));
         }
         this.min = b;
         this.max = c;
      },
      ...
      unsquish: function () {
         ...
         b
            ? (j =
                 ...
                 (r(g)
                    ? [g]
                    : e < p(a.autoRotationLimit, 80) && a.autoRotation)) &&
              o(j, function (a) {
                 var b;
                 if (a === g || (a && a >= -90 && a <= 90))
                    (i = l(Q(h.h / aa(ha * a)))),
      ...
      getOffset: function () {
         ...
         n = Math.abs(y) + n;
         y &&
            ((n -= c), (n += u * (g ? p(v.y, a.tickRotCorr.y + u * 8) : v.x)));
   ...
   Ob.prototype = {
      ...
      getPosition: function (a, b, c) {
         var d = this.chart,
            ...
            j =
               !this.followPointer &&
               p(c.ttBelow, !d.inverted === !!c.negative),
      ...
      drag: function (a) {
         ...
         if (!m || !m.touch)
            if (
               ...
               m &&
                  f &&
                  ((d -= n), m.attr({ width: Q(d), x: (d > 0 ? 0 : d) + n }));
               m &&
                  g &&
                  ((d = e - q),
                  m.attr({ height: Q(d), y: (d > 0 ? 0 : d) + q }));
   ...
   pb.prototype = {
      ...
      handleOverflow: function (a) {
         ...
         if (a > f && k.enabled !== !1) {
            ...
            if (!i)
               (i = b.clipRect = d.clipRect(0, q, 9999, 0)),
   ...
   gb.prototype = {
      ...
      drawChartBox: function () {
         ...
         if (l)
            h
               ? h.animate(x)
               : (this.plotBGImage = b.image(l, q, p, o, r).add());
         u
            ...
            if (j) j.animate({ d: f });
               ...
               (j = { stroke: c[1], "stroke-width": d, fill: g, zIndex: 1 }),
                  c[2]
                     ? (j.dashstyle = c[2])
                     : e &&
                       (j["stroke-linecap"] = j["stroke-linejoin"] = "round"),
         ...
         if (d.length && (i || k) && l.min !== z)
            i && i.hide(),
               ...
               o(d, function (d, o) {
                  ...
                  if (l.isXAxis) {
                     if (
                        ((h = { x: q ? x : r, y: 0, width: y, height: j }), !v)
                     )
   ...
   s(fa.prototype, {
      update: function (a, b) {
         var c = this.chart,
            a = (c.options[this.coll][this.options.index] = D(
               this.userOptions,
               a
            ));
         this.destroy(!0);
      ...
      getGraphPath: function (a) {
         ...
         for (f = 0; f < a.length; f++)
            if (
               ...
               c || o(f, f - 1, "left");
               if (!g || d || !c)
                  i.push(a[f]), h.push({ x: f, plotX: j, plotY: q });
               c || o(f, f + 1, "right");
            }
         f = b.call(this, i, !0, !0);
         h.reversed = !0;
   ...
   ea = {
      ...
      translate: function (a) {
         ...
         var b = 0,
            ...
            i =
               (this.endAngleRad = (qa / 180) * (p(c.endAngle, i + 360) - 90)) -
               k,
            j = this.points,
            ...
            for (d = e + 1; d < b; ++d)
               if (
                  ...
                  k &&
                     ...
                     (l = !(
                        m.x + o.translateX >
                           l.x + n.translateX + (k.width - p) ||
                        m.x + o.translateX + (j.width - p) <
                           l.x + n.translateX ||
                        m.y + o.translateY >
                           l.y + n.translateY + (k.height - p) ||
